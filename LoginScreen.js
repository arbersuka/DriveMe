...
import { Container, Header, Content, Form, Item, Input, Label, Button, Text, Body, Title, Right,Left,Icon } from 'native-base';
...
export default class LoginScreen extends React.Component {
    ...
    onSubmitBtnPressed() {
        firebase.auth()
            ...
            Alert.alert("Login Succesful", "You have been looged in");
    }
